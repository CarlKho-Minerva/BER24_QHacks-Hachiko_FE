...
import _styles from "./NotificationBarGreen.module.css";
...
export function NotificationBarGreen({
  as: _Component = _Builtin.Block,
  iconLeftImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c81d_success-message-notification-bar-dashflow-webflow-template.svg",
  iconLeftVisibility = true,
  text = "Sucess message: Lorem ipsum dolor sit amet consectur amerlo",
  closeIconProps = {},
}) {
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "notification-bar", "green")}
      tag="div"
    >
      <_Builtin.Block
      ...
      >
        ...
        >
          {iconLeftVisibility ? (
            <_Builtin.Image
              className={_utils.cx(_styles, "notification-bar-icon", "green")}
              loading="eager"
              width="auto"
              height="auto"
              alt=""
        ...
        <_Builtin.Block
          ...
          data-w-id="e857dcd5-f1b6-2479-f877-ea1f75bc80b4"
          tag="div"
          {...closeIconProps}
        >
          <_Builtin.Block
