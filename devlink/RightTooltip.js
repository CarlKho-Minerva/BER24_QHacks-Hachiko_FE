...
import _styles from "./RightTooltip.module.css";
...
export function RightTooltip({
  ...
  return (
    <_Component
      ...
      data-w-id="1d426e64-f789-ee8f-5504-71af877ec3a3"
      tag="div"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "flex-horizontal", "justify-start")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "tooltip", "right")}
          tag="div"
        >
          <_Builtin.Block tag="div">{tooltipText}</_Builtin.Block>
          <_Builtin.Image
            className={_utils.cx(_styles, "tooltip-triangle-left")}
            loading="eager"
            width="auto"
            height="auto"
            alt=""
            src="https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c839_tooltip-triangle-left-dashflow-webflow-template.svg"
          />
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
