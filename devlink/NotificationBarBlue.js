...
import _styles from "./NotificationBarBlue.module.css";
...
export function NotificationBarBlue({
  as: _Component = _Builtin.Block,
  iconLeftImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c81c_information-message-notification-bar-dashflow-webflow-template.svg",
  iconLeftVisibility = true,
  text = "Information message: Lorem ipsum dolor sit amet consectur amerlo",
  closeIconProps = {},
}) {
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "notification-bar", "blue")}
      id={_utils.cx(
        _styles,
    ...
    >
      ...
      >
        ...
        >
          {iconLeftVisibility ? (
            <_Builtin.Image
              className={_utils.cx(_styles, "notification-bar-icon", "blue")}
              loading="eager"
              width="auto"
              height="auto"
              alt=""
        ...
        <_Builtin.Block
          ...
          data-w-id="f19763a7-a319-6fea-a8e7-c1e735b1a145"
          tag="div"
          {...closeIconProps}
        >
          <_Builtin.Block
