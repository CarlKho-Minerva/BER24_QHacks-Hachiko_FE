...
import { Avatar40Px } from "./Avatar40Px";
import { BadgeGreen } from "./BadgeGreen";
import { BadgeRed } from "./BadgeRed";
import * as _utils from "./utils";
import _styles from "./UserTableRow.module.css";
...
export function UserTableRow({
  ...
  avatar = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c81a_avatar-image-dashflow-webflow-template.jpg",
  name = "John Carter",
  ...
  return (
    <_Component className={_utils.cx(_styles, "user-table-row")} tag="div">
      <_Builtin.Block
        className={_utils.cx(
          _styles,
          "flex",
