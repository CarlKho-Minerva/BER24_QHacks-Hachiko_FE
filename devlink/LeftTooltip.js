...
import _styles from "./LeftTooltip.module.css";
...
export function LeftTooltip({
  ...
  return (
    <_Component
      ...
      data-w-id="5c80fe5c-7a65-93ba-d547-cfe066a83107"
      tag="div"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "flex-horizontal", "justify-end")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "tooltip", "left")}
          tag="div"
        >
          <_Builtin.Block tag="div">{tooltipText}</_Builtin.Block>
          <_Builtin.Image
            className={_utils.cx(_styles, "tooltip-triangle-right")}
            loading="eager"
            width="auto"
            height="auto"
            alt=""
            src="https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c836_tooltip-triangle-right-dashflow-webflow-template.svg"
          />
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
