...
import _styles from "./BreadcrumbV2Item.module.css";
...
export function BreadcrumbV2Item({
  as: _Component = _Builtin.Block,
  breadcrumbDividerImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c835_breadcrumb-divider-dashflow-webflow-template.svg",
  breadcrumbDividerVisibility = true,

  breadcrumbLink = {
    href: "#",
  },

  breadcrumbIconVisibility = true,
  breadcrumbIconImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c832_breadcrumb-icon-1-dashflow-webflow-template.svg",
  ...
  return (
    ...
    >
      <_Builtin.Link
        className={_utils.cx(_styles, "breadcrumb-badge")}
        button={false}
        block="inline"
        options={breadcrumbLink}
      >
        {breadcrumbIconVisibility ? (
          <_Builtin.Image
            className={_utils.cx(_styles, "max-w-14px", "max-w-12px-mbp")}
            loading="eager"
            width="auto"
            height="auto"
            alt=""
            src={breadcrumbIconImage}
          />
        ) : null}
        <_Builtin.Block tag="div">{breadcrumbText}</_Builtin.Block>
      </_Builtin.Link>
      {breadcrumbDividerVisibility ? (
        <_Builtin.Image
