...
import _styles from "./PricingCardV3.module.css";
...
export function PricingCardV3({
  ...
  title = "Plan",
  price = "$249",
  priceInfoVisibility = true,
  priceInfoText = "/monthly",
  icon = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c828_pricing-card-icon-dashflow-webflow-template.png",
  text = "A gravida morbi tellus vitae misi non in risus nulla est nibh convallis quam mauris dolor.",
  ...
  return (
    ...
    >
        ...
        >
          <_Builtin.Block tag="div">
            ...
            >
              ...
              {priceInfoVisibility ? (
                <_Builtin.Block
                  className={_utils.cx(_styles, "mg-bottom-4px")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
          ...
          <_Builtin.Image
            className={_utils.cx(_styles, "card-icon-square", "_40px")}
            loading="eager"
            width="auto"
            height="auto"
            alt=""
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "divider", "_20px", "min-h-1px")}
        tag="div"
      />
      <_Builtin.Block
        className={_utils.cx(_styles, "mg-bottom-20px")}
        tag="div"
      >
        {text}
      </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "grid-1-column")} tag="div">
        <ButtonPrimary
          text={buttonText}
          link={buttonLink}
