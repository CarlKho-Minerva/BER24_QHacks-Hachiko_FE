...
import _styles from "./HelpMessage.module.css";
...
export function HelpMessage({
  ...
  iconImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c8bb_help-message-icon-dashflow-webflow-template.svg",
  iconVisibility = true,
  messageText = "Must be at least 8 characters",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component className={_utils.cx(_styles, "help-message")} tag="div">
      <_Builtin.Block
      ...
      >
        {iconVisibility ? (
          <_Builtin.Image
            className={_utils.cx(_styles, "max-w-12px")}
            loading="eager"
            width="auto"
            height="auto"
            alt=""
