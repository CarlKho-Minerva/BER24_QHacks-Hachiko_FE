...
import _styles from "./PricingCardV2.module.css";
...
export function PricingCardV2({
  ...
  return (
    ...
    >
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "grid-1-column", "mg-bottom-24px")}
        tag="div"
      >
        <ButtonPrimary
          text={buttonText}
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "grid-1-column", "gap-row-12px")}
        tag="div"
      >
        {feature1Visibility ? (
          <_Builtin.Block
