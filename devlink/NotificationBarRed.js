...
import _styles from "./NotificationBarRed.module.css";
...
export function NotificationBarRed({
  as: _Component = _Builtin.Block,
  iconLeftVisibility = true,
  iconLeftImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c81e_error-message-notification-bar-dashflow-webflow-template.svg",
  text = "Error message: Lorem ipsum dolor sit amet consectur amerlo",
  closeIconProps = {},
}) {
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "notification-bar", "red")}
      tag="div"
    >
      <_Builtin.Block
      ...
      >
        ...
        >
          {iconLeftVisibility ? (
            <_Builtin.Image
              className={_utils.cx(_styles, "notification-bar-icon", "red")}
              loading="eager"
              width="auto"
              height="auto"
              alt=""
        ...
        <_Builtin.Block
          ...
          data-w-id="a365ed5f-fe2f-fe10-fd79-977dd89289a5"
          tag="div"
          {...closeIconProps}
        >
          <_Builtin.Block
