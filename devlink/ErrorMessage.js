...
import _styles from "./ErrorMessage.module.css";
...
export function ErrorMessage({
  ...
  iconImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c8ba_error-message-icon-dashflow-webflow-template.svg",
  iconVisibility = true,
  messageText = "There's been an error",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "error-message", "small")}
      tag="div"
    >
      <_Builtin.Block
