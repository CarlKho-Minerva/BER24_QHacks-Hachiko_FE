...
import { Avatar32Px } from "./Avatar32Px";
import * as _utils from "./utils";
import _styles from "./TaskCardV2.module.css";
...
export function TaskCardV2({
  ...
  title = "Card title",
  text = "A gravida morbi tellus vitae misi non in risus nulla est nibh doleroli convallis quam mauris dolor.",
  badgeText = "Category",
  avatarImage = "https://uploads-ssl.webflow.com/660d670d57461f6bb915c687/660d670e57461f6bb915c81a_avatar-image-dashflow-webflow-template.jpg",
  date = "Nov 24",
  dateProps = {},
  firstButtonProps = {},
  secondButtonProps = {},
  ...
  return (
    <_Component className={_utils.cx(_styles, "card", "pd-24px")} tag="div">
      ...
      <_Builtin.Paragraph className={_utils.cx(_styles, "mg-bottom-12px")}>
        {text}
      </_Builtin.Paragraph>
      <_Builtin.Block
        className={_utils.cx(
      ...
      >
        ...
        >
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "text-50", "color-neutral-500")}
            tag="div"
            {...dateProps}
          >
            {date}
